...
@section('content')
	...
	<h1><img src="{{ url('images/anderwijs-logo.png') }}" alt="Logo Anderwijs"
			 style="height:2.5em;margin-right:30px;vertical-align:bottom;"> <span style="white-space:nowrap;">Inschrijven als nieuwe vrijwilliger</span>
	</h1>

	<hr/>

	<p>Wat leuk dat je met ons op kamp wil gaan. Vul het onderstaande formulier zo volledig mogelijk in en wij nemen zo
		spoedig mogelijk contact met je op over het verdere proces. De informatie die je opgeeft wordt alleen door
		Anderwijs verwerkt en bewaard, en zal <b>nooit</b> worden gedeeld met derden.</p>

	<div class="well"><strong>Let op! </strong>Ben je al eens eerder met ons op kamp geweest? Meld je dan niet hier
		opnieuw aan, maar log in op <a href="{{ url('/') }}">AAS 2.0</a> of stuur een mailtje naar de <a
				href="mailto:kamp@anderwijs.nl">kampcommissie</a>.
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-7 form-group">
			...
			{!! Form::select('geslacht', array_merge([ '' => '' ], iterator_to_array(Gender::All())), null, ['class' => 'form-control']) !!}
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-5">
			<div class="well well-sm">
				Zie ook het <a href="https://anderwijs.nl/onze-bijleskampen/kampagenda/" target="_blank">kampschema</a>
				(link wordt geopend in nieuw venster).
			</div>
		</div>
	</div>
	<div class="row">
	...
	<div class="well">
		Geef hieronder aan welke vakken je zou kunnen geven op kamp. Minstens één en zoveel als je wilt. Voorzie ieder
		vak ook van een klas, dit slaat op het hoogste niveau waarop je het vak kunt geven, gerekend naar VWO (voor HAVO
		moet je dit dus compenseren).
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="checkbox">
				<label>
					{!! Form::checkbox('vog', 1) !!} Ik ga akkoord dat ik een <strong>Verklaring Omtrent het Gedrag
						(VOG)</strong> moet aanvragen en inleveren om mee te mogen op kamp. Anderwijs vergoedt eventuele
					kosten die hieraan verbonden zijn (over de aanvraagprocedure volgt apart bericht).
				</label>
			</div>
			<div class="checkbox">
				<label>
