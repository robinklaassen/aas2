...
@section('content')
	...
	<p>Vul het onderstaande formulier zo volledig mogelijk in. Benieuwd hoe het na inschrijving verder gaat? Bekijk dan
		het
	...
	<div class="well">
		<strong>Let op: is uw kind al eerder met ons op kamp geweest?</strong> Schrijf hem/haar dan niet hier opnieuw
		in,
		maar log in op ons <a href="{{ url('/') }}">administratiesysteem</a>. Daar kunt u de bij ons bekende
		gegevens controleren en aanvullen en uw kind eenvoudig op een nieuw kamp sturen. Heeft u nog geen account, of
		bent u
	...
	<div class="row">
		...
		<div class="col-sm-6 form-group">
			{!! Form::label('geslacht', 'Geslacht/gender:') !!} <span class="glyphicon glyphicon-question-sign"
																	  data-toggle="tooltip"
																	  title="Dit gebruiken we bijvoorbeeld voor het indelen van slaapzalen."></span><br/>
	...
	<div class="row">
		<div class="col-sm-9">
			<p class="well well-sm">
				Bij inschrijving voor een kamp geeft u Anderwijs automatisch toestemming om u per mail of telefoon te
				mogen
				contacteren met vragen of informatie met betrekking tot dat specifieke kamp. Daarnaast bieden we u de
				mogelijkheid om per mail op de hoogte gehouden te worden van nieuwe kampen en eventuele aanbiedingen
				&mdash;
	...
	<div class="row">
		<div class="col-sm-5">
			...
			<div class="well well-sm">
				Zie ook de <a href="https://anderwijs.nl/onze-bijleskampen/kampagenda/" target="_blank">kampagenda</a>
				(link wordt
		...
		<div class="col-sm-7">
			<h3>Kosten</h3>
			<div class="well well-sm">
				De actuele kampprijzen staan in de <a href="https://anderwijs.nl/onze-bijleskampen/kampagenda/"
													  target="_blank">kampagenda</a>.
				Anderwijs kent een <a href="https://www.anderwijs.nl/onze-bijleskampen/kosten/" target="_blank">kortingsregeling</a>
				op de kampprijs afhankelijk van het bruto maandelijks
	...
	<div class="row">
		<div class="col-sm-9">
			<div class="well well-sm">
				Hieronder kunt u de vakken waar op kamp aandacht aan moet worden besteed, opgeven. Bij ieder vak kunt u
				in
			...
			<div class="checkbox">
				<label>
					{!! Form::checkbox('voorwaarden', 1) !!} Ik ga akkoord met de <a
							href="https://www.anderwijs.nl/onze-bijleskampen/algemene-voorwaarden/" target="_blank">algemene
						voorwaarden</a>
