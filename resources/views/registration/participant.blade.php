...
<p>Vul het onderstaande formulier zo volledig mogelijk in. Benieuwd hoe het na inschrijving verder gaat? Bekijk dan het <a href="http://www.anderwijs.nl/kampen/stappenplan-inschrijving/" target="_blank">stappenplan voor de inschrijving</a> (link opent in een nieuw venster). De informatie die je opgeeft wordt alleen door Anderwijs verwerkt en bewaard, en zal <b>nooit</b> worden gedeeld met derden.</p>

<div class="well">
	<strong>Let op: is uw kind al eerder met ons op kamp geweest?</strong> Schrijf hem/haar dan niet hier opnieuw in, maar log in op ons <a href="http://aas2.anderwijs.nl">administratiesysteem</a>. Daar kunt u de bij ons bekende gegevens controleren en aanvullen en uw kind eenvoudig op een nieuw kamp sturen. Heeft u nog geen account, of bent u uw inloggegevens vergeten, stuur dan een mail naar de <a href="mailto:kantoor@anderwijs.nl">kantoorcommissie</a>.
</div>
...
<div class="row">
	<div class="col-sm-9">
		<p class="well well-sm">
			Bij inschrijving voor een kamp geeft u Anderwijs automatisch toestemming om u per mail of telefoon te mogen contacteren met vragen of informatie met betrekking tot dat specifieke kamp. Daarnaast bieden we u de mogelijkheid om per mail op de hoogte gehouden te worden van nieuwe kampen en eventuele aanbiedingen &mdash; wilt u die ontvangen, kiest u dan hieronder voor 'Ja'.
		</p>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-5">
		...
		<div class="well well-sm">
			Zie ook de <a href="http://www.anderwijs.nl/kampen/kampagenda/" target="_blank">kampagenda</a> (link wordt geopend in nieuw venster).<br/><br/>
	...
	<div class="col-sm-7">
		<h3>Kosten</h3>
		<div class="well well-sm">
			Klik <a href="http://www.anderwijs.nl/kampen/kampagenda/" target="_blank">hier</a> voor de actuele kampprijzen. Anderwijs kent een kortingsregeling op de kampprijs afhankelijk van het bruto maandelijks gezinsinkomen. Controleer ook de <a href="http://www.anderwijs.nl/algemene-voorwaarden/" target="_blank">voorwaarden</a> om voor korting in aanmerking te komen (links worden geopend in een nieuw venster). Als u in aanmerking komt voor korting, stuur dan ook een inkomensverklaring van u en uw (eventuele) partner naar onze postbus t.a.v. de penningmeester.
		</div>
		<div class="form-group">
...
<div class="row">
	<div class="col-sm-9">
		<div class="well well-sm">
			Hieronder kunt u de vakken waar op kamp aandacht aan moet worden besteed, opgeven. Bij ieder vak kunt u in het tekstvak ernaast extra informatie opgeven, zoals de onderwerpen en moeilijkheden in kwestie.
		</div>
	</div>
</div>
