...
<h1>{{ $camp->naam }} {{ $camp->datum_start->format('Y') }} ({{ $camp->code }})</h1>
...
<table class="frontpage">
	...
	<tr>
		...
		<td style="width:40em;">{{ $camp->datum_voordag->format('d-m-Y') }}</td>
	</tr>
	<tr>
		<td>Start kamp</td>
		<td>{{ $camp->datum_start->format('d-m-Y') }}</td>
	</tr>
	<tr>
		<td>Eind kamp</td>
		<td>{{ $camp->datum_eind->format('d-m-Y') }}</td>
	</tr>
	<tr>
		<td>Locatie</td>
		<td>{{ $camp->location->naam }} ({{ $camp->location->plaats }})</td>
	</tr>
	<tr>
