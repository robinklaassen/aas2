...
<div class="row">
	...
	<div class="col-md-6">
		<h4>Hoe legt de anderwijder de stof uit?</h4>
		<div id="stof-div"></div>
		@barchart('stof', 'stof-div')
	</div>
	
	<div class="col-md-6">
		<h4>Hoeveel aandacht gaf de anderwijder je tijdens de blokjes?</h4>
...
<div class="row">
	...
	<div class="col-md-6">
		<h4>Hoe vond je het om door de anderwijder bijgespijkerd te worden?</h4>
		<div id="mening-div"></div>
		@barchart('mening', 'mening-div')
	</div>
	
	<div class="col-md-6">
		<h4>Hoe tevreden ben je over wat je met de anderwijder hebt bereikt?</h4>
