...
<div class="row">
	<div class="col-sm-9">
		<div class="well">
			Hieronder kunt de vakken waar op kamp aandacht aan moet worden besteed, opgeven. Bij ieder vak kunt u in het
			tekstvak ernaast extra informatie opgeven, zoals de onderwerpen en moeilijkheden in kwestie.
		</div>
	</div>
</div>
...
@for ($i = 0; $i < 6; $i++) <div class="row">
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="well">
				<strong>Let op! </strong>Bij aanmelding gaat u automatisch akkoord met onze <a
					href="https://www.anderwijs.nl/algemene-voorwaarden/" target="_blank">algemene voorwaarden</a> (link
