...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#leden" aria-controls="leden" role="tab" data-toggle="tab">Leden</a></li>
    <li role="presentation"><a href="#deelnemers" aria-controls="deelnemers" role="tab" data-toggle="tab">Deelnemers</a></li>
  </ul>
			...
			<table class="table table-hover" id="ledenTable">
				...
				<tbody>
					@foreach ($memberUsers as $user)
						<tr>
							<td>{{ $user->username }}</td>
							<td><a href="{{ url('/members', $user->profile->id) }}">{{ $user->profile->voornaam }} {{ $user->profile->tussenvoegsel }} {{ $user->profile->achternaam }}</a></td>
